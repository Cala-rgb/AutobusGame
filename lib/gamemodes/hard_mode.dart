...
import '../widgets/wrong_popup.dart';
          ...
          body: Container(
            ...
            child: Column(
              children: [
                ...
                SizedBox(height: 10,),
                Text(
                  "Smaller or bigger then ${_cards[index].getActualNumber() <=
                      10 ? (_cards[index].getNumber()) : ("${_cards[index]
                      .getNumber()}/${_cards[index].getActualNumber()}")}?",
                  style: CustomTextStyle.customText4,
                ),
                Padding(
                  padding: const EdgeInsets.symmetric(horizontal: 10),
                ...
                Row(
                  ...
                  children: [
                    ElevatedButton(
                      ...
                      child: Text("Smaller",
                        style: CustomTextStyle.customText4.apply(
                            color: Colors.white),),
                    ),
                    SizedBox(width: 20,),
                    ElevatedButton(
